...
class AboutClassMethods < Neo::Koan
  ...
  class Dog
    def self.class_method2    #MYKAELOS: I like this, a lot.
  ...
  class Dog
    class << self       #MYKAELOS: And then you ruined it Ruby. What's even going on here?
  ...
  #MYKAELOS: self.method is good for one-off methods, and class << self is good for several class methods. Might be better to always use class << self for consistancy.
