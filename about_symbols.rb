...
class AboutSymbols < Neo::Koan
  ...
  # MYKAELOS: Because if we try to assert the symbol exists by using it, we'll accidently define it in the assertion, and it'll always be true...
  ...
  #MYKAELOS: They're unique keys stored in memory that is never garbage collected because they're static...
end
