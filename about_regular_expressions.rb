...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    # MYKAELOS: If the match didn't exist anywhere.
  end
  ...
  #
  # Why?
  # MYKAELOS: Because they will match as many as possible, "or more".
  ...
  #MYKAELOS: Well, () will capture a substring. [] matches any character inside, while (|) is aimed at matching groups of characters.
  # So technically [abc] is similar to (a|b|c), but (|) allows matching very specific things like (banana|orange), whereas [] restricts characters selected.
  # ------------------------------------------------------------------
